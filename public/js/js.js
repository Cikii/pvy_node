...
socket.on('message', (msg, name, date) => {
    zpravy.innerHTML += "<div id='zprava' class='row'><div id='box-zleva' class='col-xs-6'><img src='./avatar2.jpg' height='150px'></div><div id='box-zprava' class='col-xs-6'><h1>"+name+"</h1><p>"+date+"</p><p>"+msg+"</p></div></div>";
});     